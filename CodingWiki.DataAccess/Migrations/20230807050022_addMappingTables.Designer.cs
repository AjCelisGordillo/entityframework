...
namespace CodingWiki.DataAccess.Migrations
{
    ...
    [Migration("20230807050022_addMappingTables")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CodingWiki.Model.Models.Fluent_BookAuthorMap", b =>
                {
                    b.Property<int>("Author_Id")
                        .HasColumnType("int");
                    ...
                    b.ToTable("BookAuthorMaps_Fluent");
                });
            ...
            modelBuilder.Entity("CodingWiki.Model.Models.Fluent_Publisher", b =>
                {
                    b.Property<int>("Publisher_Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CodingWiki.Model.Models.Fluent_Book", b =>
                {
                    b.HasOne("CodingWiki.Model.Models.Fluent_Publisher", "Publisher")
                        .WithMany("Books")
                        .HasForeignKey("Publisher_Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("CodingWiki.Model.Models.Fluent_BookAuthorMap", b =>
                {
                    b.HasOne("CodingWiki.Model.Models.Fluent_Author", "Author")
                        .WithMany("BookAuthorMap")
                        .HasForeignKey("Author_Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("CodingWiki.Model.Models.Fluent_Book", "Book")
                        .WithMany("BookAuthorMap")
                        .HasForeignKey("Book_Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("CodingWiki.Model.Models.Fluent_BookDetail", b =>
                {
                    b.HasOne("CodingWiki.Model.Models.Fluent_Book", "Book")
                        .WithOne("BookDetail")
                        .HasForeignKey("CodingWiki.Model.Models.Fluent_BookDetail", "Book_Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
